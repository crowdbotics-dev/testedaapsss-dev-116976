"""
Django settings for testedaapsss_dev_116976 project.
...
ROOT_URLCONF = 'testedaapsss_dev_116976.urls'
...
WSGI_APPLICATION = 'testedaapsss_dev_116976.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testedaapsss_dev_116976 API",
    "DESCRIPTION": "API documentation for testedaapsss_dev_116976 App",
    "VERSION": "v1",
}
